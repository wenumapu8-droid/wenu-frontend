const root = document.querySelector("[data-kdx-flip]");
...
const phaseLabel = root?.querySelector("[data-kdx-phase]");
const fpsLabel = root?.querySelector("[data-kdx-fps]");

if (!(canvas instanceof HTMLCanvasElement)) {
  throw new Error("KDX_PERSPECTIVE_FLIP: canvas not found.");
}
...
const [vertexSource, fragmentSource] = await Promise.all([
  ...
  fetch("../shaders/perspective-flip.frag.glsl").then((response) => response.text()),
]);
