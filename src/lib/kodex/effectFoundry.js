...
export const KODEX_EFFECTS = Object.freeze([
  ...
  },
  {
    ...
    implementation: 'Canvas 2D deterministic cell-loss prototype integrated in ARCHIVE. Production target: feedback texture + temporal decay shader.',
    fallback: 'PNG sequence / MP4 loop',
    priority: 1,
    parameters: [
  ...
  },
  {
    ...
    implementation: 'Canvas 2D deterministic dissolution prototype integrated in RETURN. Production target: noise-field threshold + feedback/reconstruction shader.',
