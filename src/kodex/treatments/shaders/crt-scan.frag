...
uniform float u_scanline_intensity; // 0.78
uniform float u_curvature;          // 0.25
uniform float u_vignette;           // 0.40
uniform float u_phosphor_glow;      // 0.65
uniform float u_noise;              // 0.18
